...
class AppColors {
  ...
  static const primary1 = Color(0xff000000);
  static const appBarcolor = Color.fromARGB(255, 102, 116, 208);
 static const grey700 = Color(0xff272835);
  static const grey600 = Color(0xff36394a);
  static const appBarColor200 = Color.fromARGB(255, 68, 170, 164);
